...
The [Quality Attributes](../../How-To/QualityAttributes/About-Quality-Attributes-Folder.md) information will help you enrich the personas, for example by [building quality attribute pyramids](Building-Attribute-Pyramids.md) or radar diagrams to show what attributes the tool required for each persona.
