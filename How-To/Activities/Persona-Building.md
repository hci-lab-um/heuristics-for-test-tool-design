...
The [Quality Attributes](../../How-To/QualityAttributes/About-Quality-Attributes.md) information will help you enrich the personas, for example by [building quality attribute pyramids](../../How-To/Activities/Building-Attribute-Pyramids.md) or radar diagrams to show what attributes the tool required for each persona.
