...
What risks need not be considered for the tool and the workflows?
 


### Else?

What other risks might be associated with the tool and the workflows?
...
Hold a Risk Workshop to identify and assess the risks. Good resources are available in the testing community, for example, you could use [Risk Storming](https://riskstorming.com/) as a workshop, [Would Heu-Risk It?](https://pejgan.se/wouldheu-riskit.html) cards, or use risk storming cards from Ministery of Testing, [need to be logged in to MoT to access](https://www.ministryoftesting.com/testsphere/riskstorming).
